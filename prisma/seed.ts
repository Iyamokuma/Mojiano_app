...
const categories = [
  ...
  { name: "Christmas / Halloween", slug: "christmas-halloween", image: "https://images.unsplash.com/photo-1512389142860-9c449e58a934?auto=format&fit=crop&w=1200&q=80", description: "Seasonal décor, lighting and festive homeware." },
  { name: "DIY & Auto", slug: "diy-auto", image: "https://images.unsplash.com/photo-1504148458000-0471d1165b6d?auto=format&fit=crop&w=1200&q=80", description: "Tools, storage and automotive essentials." },
...
const products: SeedProduct[] = [
  ...
  { category: "christmas-halloween", name: "Warm White Fairy Light Set", sku: "SEA-3301", price: 899, compareAt: 1499, sale: 749, stock: 60, short: "Indoor/outdoor festive lighting.", description: "A long-run warm white fairy light set, ideal for Christmas displays or year-round ambient lighting.", image: "https://images.unsplash.com/photo-1512389142860-9c449e58a934?auto=format&fit=crop&w=1400&q=80", clearance: true, featured: true },
  { category: "christmas-halloween", name: "Halloween Porch Lantern Duo", sku: "SEA-1188", price: 1299, stock: 22, short: "Seasonal lantern pair for doorways.", description: "A pair of decorative Halloween lanterns from seasonal clearance. Battery tealight compatible.", image: "https://images.unsplash.com/photo-1509557965875-b88c97052fa0?auto=format&fit=crop&w=1400&q=80", newArrival: true },
  { category: "diy-auto", name: "126-Piece Tool Kit", sku: "DIY-6412", price: 3299, compareAt: 5499, stock: 15, brand: "Forge", short: "Socket set and household tools in a carry case.", description: "A complete starter tool kit covering sockets, drivers and pliers. Suitable for home, garage and mixed trade use.", image: "https://images.unsplash.com/photo-1504148458000-0471d1165b6d?auto=format&fit=crop&w=1400&q=80", featured: true, bestSeller: true },
  ...
  { category: "mixed-households", name: "Storage Basket Trio", sku: "MIX-2044", price: 1699, compareAt: 2800, stock: 25, short: "Woven storage baskets, set of three.", description: "Three nested storage baskets for bathrooms, nurseries and living rooms.", image: "https://images.unsplash.com/photo-1616628188541-925660ab1447?auto=format&fit=crop&w=1400&q=80" },
  { category: "miscellaneous", name: "Mystery Value Parcel", sku: "MSC-0101", price: 999, compareAt: 2500, sale: 899, stock: 50, short: "Surprise parcel of mixed clearance goods.", description: "A value parcel drawn from mixed miscellaneous stock. Contents change with incoming pallets. Always more than the ticket price.", image: "https://images.unsplash.com/photo-1513885535751-8b9238bd345a?auto=format&fit=crop&w=1400&q=80", clearance: true, featured: true },
  { category: "miscellaneous", name: "LED Desk Lamp", sku: "MSC-2219", price: 1799, stock: 21, short: "Adjustable LED task lamp.", description: "An adjustable LED desk lamp with warm and cool settings. Ideal for home offices.", image: "https://images.unsplash.com/photo-1507473883500-2dd6282412c8?auto=format&fit=crop&w=1400&q=80" },
  ...
  { category: "summer-stock", name: "Garden Parasol 2.7m", sku: "SUM-2701", price: 3499, compareAt: 5999, sale: 2999, stock: 7, short: "Crank-and-tilt garden parasol.", description: "A 2.7m garden parasol from summer clearance. Base sold separately. Ideal for patios and trade lots.", image: "https://images.unsplash.com/photo-1469796466631-9d8171f56c36?auto=format&fit=crop&w=1400&q=80", clearance: true },
  ...
  { category: "kitchenware", name: "Stoneware Dinner Set for 4", sku: "KIT-2088", price: 2999, stock: 13, short: "16-piece dinner set in warm stone.", description: "A 16-piece stoneware dinner set. Reactive glaze in a calm peach-stone finish. Dishwasher safe.", image: "https://images.unsplash.com/photo-1603190287605-4f70b88c1c6f?auto=format&fit=crop&w=1400&q=80", newArrival: true },
...
async function main() {
  ...
  await prisma.siteSettings.upsert({
    ...
    create: {
      ...
      address: "Unit 4, Riverside Trade Park, Manchester, M4 1AA",
  ...
  const content = [
    { key: "hero", title: "Big clearance sale", body: "Quality products at wholesale and clearance prices. Shop trusted categories, from home and electrical to fashion, furniture and seasonal stock.", image: "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?auto=format&fit=crop&w=1800&q=80", ctaLabel: "Shop now", ctaHref: "/shop", sortOrder: 1 },
    { key: "value_trust", title: "Trusted stock", body: "Wholesale lots, overstock and clearance lines selected for everyday value.", ctaLabel: "", ctaHref: "", sortOrder: 2 },
    { key: "value_price", title: "Clearance prices", body: "Compare-at pricing shown wherever remaining retail tickets allow.", ctaLabel: "", ctaHref: "", sortOrder: 3 },
    { key: "value_support", title: "WhatsApp support", body: "Ask about a product, delivery or a wholesale enquiry without leaving the site.", ctaLabel: "", ctaHref: "", sortOrder: 4 },
